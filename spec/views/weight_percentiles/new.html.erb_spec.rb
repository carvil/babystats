...
describe "weight_percentiles/new.html.erb" do
  before(:each) do
    assign(:weight_percentile, stub_model(WeightPercentile,
      :month => 1,
      :l => 1.5,
      :mean => 1.5,
      :sample_sd => 1.5,
  ...
  it "renders new weight_percentile form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => weight_percentiles_path, :method => "post" do
