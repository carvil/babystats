...
describe "head_circumference_percentiles/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit head_circumference_percentile form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => head_circumference_percentiles_path(@head_circumference_percentile), :method => "post" do
