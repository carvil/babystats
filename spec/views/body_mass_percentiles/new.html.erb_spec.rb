...
describe "body_mass_percentiles/new.html.erb" do
  before(:each) do
    assign(:body_mass_percentile, stub_model(BodyMassPercentile,
      :month => 1,
      :l => 1.5,
      :mean => 1.5,
      :sample_sd => 1.5,
  ...
  it "renders new body_mass_percentile form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => body_mass_percentiles_path, :method => "post" do
