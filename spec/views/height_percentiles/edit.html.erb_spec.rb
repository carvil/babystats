...
describe "height_percentiles/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit height_percentile form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => height_percentiles_path(@height_percentile), :method => "post" do
